...
const ComparisonTable = () => {
    ...
    const comparisonData: ComparisonItem[] = [
        ...
        },
        {
            ...
            now: `${ownerProfile.ownershipType === 'Deeded' ? 'Up to 12' : 'Up to 10'} months`,
            new: 'Up to 12 months',
            sentiment: ownerProfile.ownershipType === 'Deeded' ? 'neutral' : 'positive'
        },
        {
            feature: 'Exit Strategy',
            now: ownerProfile.ownershipType === 'Deeded' ? <span className="text-destructive flex items-center gap-2"><XCircle size={16}/> In Perpetuity</span> : <span className="text-success flex items-center gap-2"><CheckCircle size={16}/> Flexible</span>,
